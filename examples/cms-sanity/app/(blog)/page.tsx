...
export default async function Page() {
  ...
  return (
    <div className="container mx-auto px-5">
      ...
      {heroPost ? (
        <HeroLayoutShift id={heroPost._id}>
...
function Intro(props: { title: string | null | undefined; description: any }) {
  const editable = dataAttribute({ type: "settings", id: "settings" });
  return (
  ...
  return (
    <>
      ...
      <div className="mb-20 md:mb-28 md:grid md:grid-cols-2 md:gap-x-16 lg:gap-x-8">
        ...
        <div>
          <div style={{ viewTransitionName: `post-content-${_id}` }}>
            {excerpt && (
          ...
          <div style={{ viewTransitionName: `post-author-${_id}` }}>
